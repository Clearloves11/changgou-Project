...
public class BrandController {
    ...
    public Result<List<Brand>> findBrandByCategory(@PathVariable(value = "id") Integer categroyId) {
        List<Brand> category = brandService.findByCategory(categroyId);
        return new Result<List<Brand>>(true, StatusCode.OK, "品牌查询成功", category);
    }
